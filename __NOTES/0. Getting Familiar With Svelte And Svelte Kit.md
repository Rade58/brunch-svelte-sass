...
# PROPS IN SVELTE COMPONENTS EXPORTED, DECLARED, BUT NOT YET INITIALIZED VARIABLES
...
**THI IS HOW WE WOULD ENABLE THAT EVERY OF OUR PAGE IS SERVER SIDE RENDERED DURING RUNTIME**
