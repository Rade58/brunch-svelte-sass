...
# KEYED `#each` IS USED WWHEN WE WANT TO ITERATE OVER PROPERTIES OF OBJECT (WE CAN SAY ITERATING OVER RECORD)

WE CAN DEFINE AN EXAMPLE, LIKE THAT IT IS BETTER TO SEE HOW IT WORKS
